self.__SERVER_FILES_MANIFEST={
  ...
  "config": {
    ...
    "outputFileTracingRoot": "/opt/nexifyai/cockpit",
    "allowedDevOrigins": [
    ...
    "_originalRewrites": {
      ...
      "afterFiles": [
        {
          "source": "/docs/vollbetrieb",
          "destination": "/docs/vollbetrieb.md"
        }
      ],
      "fallback": []
    },
    "_originalRedirects": [
      {
        "source": "/:locale(de|en|nl)/:page(login|admin|konto|registrieren|rueckruf)",
        "destination": "/:page",
        "permanent": false
      },
      {
        "source": "/arbeitsweise",
        "destination": "/de/prozess",
        "permanent": true
      },
      {
        "source": "/ueber-pascal",
      ...
      {
        "source": "/projekte",
        "destination": "/de/referenzen",
        "permanent": true
      },
      {
        "source": "/leistungen/:slug",
        "destination": "/de/leistungen/:slug",
        "permanent": true
      },
      {
        "source": "/preise",
      ...
      {
        "source": "/widerruf",
        "destination": "/de/widerruf",
        "permanent": true
      }
    ]
  },
  "appDir": "/opt/nexifyai/cockpit",
  "relativeAppDir": "",
  "files": [
